...
export const LogoLoader: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[300px] w-full bg-slate-950 p-8 rounded-xl">
      <div className="relative flex items-center justify-center">
        ...
        {/* Animated SVG Logo */}
        <svg
          className="w-40 md:w-58 relative z-10 overflow-visible"
          viewBox="0 0 658 160"
      ...
      <div className="w-24 h-[2px] bg-slate-800 rounded-full mt-8 overflow-hidden relative">
        <div className="absolute inset-y-0 bg-indigo-500 w-1/2 rounded-full animate-shimmer" />
      </div>
    </div>
  );
};