    ...
    <footer className="w-full bg-black text-white font-sans overflow-hidden mt-30">
      ...
      <div className="relative w-full h-screen sm:h-screen lg:h-screen">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute top-0 left-0 right-0 h-48 sm:h-64 bg-linear-to-b from-white via-white/80 to-transparent z-10" />

          {/* Bottom Dark Gradient: Transitions image into the black footer area */}
          <div className="absolute bottom-0 left-0 right-0 h-72 sm:h-96 bg-linear-to-t from-black via-black/80 to-transparent z-10" />
        </div>
