...
function App() {
  ...
  // Matching navbar items with corresponding section IDs
  const navLinks = [
    { name: 'HOME', targetId: 'home' },
    { name: 'PROPERTIES', targetId: 'properties' },
  ...
  return (
    <>
      ...
      {/* Properties Section */}
      <section id="properties" className="bg-[#f2f2f2] py-60 min-h-screen px-4 py-12 sm:px-8 md:px-12 lg:px-20 font-sans text-gray-900 flex items-center justify-center">
              ...
              return (
                <div key={index} className="py-6">
                  ...
                  >
                    ...
                    {/* Chevron Icon */}
                    <svg
                      className={`w-5 h-5 sm:w-6 sm:h-6 text-black flex-shrink-0 transition-transform duration-300 ${isOpen ? 'transform rotate-180' : ''
                        }`}
                      fill="none"
                      stroke="currentColor"
                      strokeWidth="2.2"
      ...
      <footer className="w-full bg-black text-white font-sans overflow-hidden mt-30">
        {/* Hero Image Section */}
        <div className="relative w-full h-[550px] sm:h-[650px] lg:h-[750px]">
          {/* Background Image */}
          <img
          ...
          <div className="absolute inset-0 pointer-events-none">
            ...
            <div className="absolute top-0 left-0 right-0 h-48 sm:h-64 bg-gradient-to-b from-white white/80 to-transparent z-10" />

            {/* Bottom Dark Gradient: Transitions image into the black footer area */}
            <div className="absolute bottom-0 left-0 right-0 h-72 sm:h-96 bg-gradient-to-t from-black via-black/80 to-transparent z-10" />
          </div>

          {/* Center Text & Button CTA */}
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 z-20">
            <h2 className="text-4xl sm:text-6xl md:text-7xl font-normal tracking-tight text-white leading-[1.15] max-w-4xl drop-shadow-md">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-20 -mt-12 relative z-20 pb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start justify-between pt-8">
            ...
            <div className="md:col-span-5 flex flex-col items-start space-y-4">
              {/* SVG Logo matching the stylized AB Monogram */}
            ...
            {/* Navigations Section */}
            <div className="md:col-span-3 flex items-start gap-4 sm:gap-6">
            ...
            <div className="md:col-span-4 flex items-start gap-4 justify-end sm:gap-6">
              <div className="flex items-center space-x-1.5 mb-3">
                <span className="text-[#f1fc7b] text-[8px]">✦</span>
                <h4 className="text-[10px] tracking-widest text-gray-400 uppercase font-semibold">
                  SOCIAL LINKS
          ...
          <div className="my-30 flex flex-col sm:flex-row items-start sm:items-center justify-center gap-4 sm:gap-6">
            ...
            >
              ...
              <button
                type="submit"
                className="bg-[#f1fc7b] hover:bg-[#e2f063] text-black font-semibold text-[10px] tracking-wider uppercase px-4 py-1.5 rounded-full transition-all duration-200"
              >
                SUBMIT
              </button>
            </form>
